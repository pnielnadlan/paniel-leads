...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'C', text: 'לקבל כיוון ראשוני לסוג העסקה שמתאימה לי עכשיו', reportFocus: 3 },
      { id: 'D', text: 'איזה מיומנויות או גישות עלי לשפר כדי להצליח יותר בנדל"ן?', reportFocus: 4 },
      { id: 'E', text: 'תהיו כנים: מתאים לי להתעסק בזה בעצמי או שלא כדאי? (ולמה) 🙂', reportFocus: 5 },
    ],
  },
];
