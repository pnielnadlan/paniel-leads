...
export const QUESTIONS: Question[] = [
  {
    ...
    options: [
      ...
      { id: 'E', text: '"אני צריך מישהו שיעזור לי להפוך את זה לתוכנית"', scores: { P5: 1 } },
    ],
  },
  {
    id: 2,
    ...
    options: [
      ...
      { id: 'C', text: 'לגלות בדיעבד שכולם ראו משהו שאני פספסתי', scores: { P2: 1 } },
      { id: 'D', text: 'להיתקע עם נכס דפוק', scores: { P4: 1 } },
      { id: 'E', text: 'דווקא לא לפעול - ואז להצטער בעוד כמה שנים', scores: { P5: 1 } },
    ],
  },
  {
    id: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'E', text: 'האם יש אופציית מימוש ויציאה לפני קבלת מפתח?', scores: { P4: 1 } },
    ],
  },
  {
    id: 7,
  ...
  },
  {
    ...
    options: [
      { id: 'A', text: 'האם אני בכיוון בכלל? האם הכסף שלי עובד נכון?', reportFocus: 1, icon: '🧭' },
      { id: 'B', text: 'האם יש בורות שעלי להיזהר מהן במיוחד? טעויות אני עלול לעשות?', reportFocus: 2, icon: '⚠️' },
      { id: 'C', text: 'לקבל כיוון ראשוני לסוג העסקה שמתאימה לי עכשיו', reportFocus: 3, icon: '🎯' },
      { id: 'D', text: 'איזה מיומנויות או גישות עלי לשפר כדי להצליח יותר בנדל"ן?', reportFocus: 4, icon: '📈' },
      { id: 'E', text: 'תהיו כנים: מתאים לי להתעסק בזה בעצמי או שלא כדאי? (ולמה) 🙂', reportFocus: 5, icon: '🤔' },
    ],
  },
];
